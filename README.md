...
| `direction`           | `string` | Yes      | `'bottom-up'` | Sets the direction of the slot machine animation. Accepted values: `'bottom-up'`, `'top-down'`. Overrides the `direction` prop if provided.   |
